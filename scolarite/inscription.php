...
<head>
    ...
    <title>Inscription et Réinscription - Ecole Supérieure Polytechnique d&#039;Antsiranana</title>
    ...
    <?php endif; ?>
        ...
        <div class="container">
           <div id="contact">
            ...
            <form  action="traitement1.php" method="POST" id="form" accept-charset="utf-8" enctype="multipart/form-data" >
                            ...
                            <div class="col-md-4" id="service-select">
                             ...
                             <div class="col-md-4">
                              ...
                              <fieldset>
                                <input name="datenaissance" type="date"  class="form-control" id="datenaissance" placeholder="Date de naissance..." required="" >
                              </fieldset>
                            </div>
                            <div class="col-md-4">
                                <p>Lieu de naissance *</p>
                              <fieldset>
                                <input name="lieunaissance" type="text" class="form-control" id="lieunaissance" placeholder="Lieu de naissance..." required="" >
                              </fieldset>
                            </div>
                            <div class="col-md-4">
                                 <p>Ville de naissance *</p>
                              <fieldset>
                                <input name="villenaissance" type="text" class="form-control" id="villenaissance" placeholder="Ville de naissance..." required="" >
                              </fieldset>
                            </div>
                            <div class="col-md-4" >
                                <p>Adresse exacte *</p>
                              <fieldset>
                                <input name="adresse" type="text" id="adresse" class="form-control" placeholder="Votre adresse..." required="" >
                              </fieldset>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4" >
                                <p>Nationalité *</p>
                              <fieldset>
                                <input name="nationalite" type="text" class="form-control" id="nationalite" placeholder="Nationalité..." required="" >
                              </fieldset>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3" id="cin">
                                        ...
                                        <fieldset>
                                            <input name="cin" type="number" minlength="12" maxlength="12" id="req-cin" class="form-control"  placeholder="CIN ou Passeport..."  >
                                        </fieldset>
                                    </div>
                                    <div class="col-md-3"  id="datecin">
                                        <p>Date de délivrance *</p>
                                      <fieldset>
                                        <input name="datecin" type="date" id="req-date" class="form-control" placeholder="Delivrée le..."  >
                                      </fieldset>
                                    </div>
                                    <div class="col-md-3" id="lieucin" >
                                        <p>Lieu de délivrance *</p>
                                      <fieldset>
                                        <input name="lieucin" type="text" id="req-lieu" class="form-control" placeholder="Lieu de delivrance ..."  >
                                      </fieldset>
                                    </div>
                            ...
                            <div class="col-md-4" id="pere" >
                              ...
                              <fieldset>
                                <input name="pere" type="text" class="form-control"  placeholder="Nom du Père..." >
                              </fieldset>
                            </div>
                            <div class="col-md-4" id="mere">
                                <p>Affiliation (fils ou fille de)</p>
                              <fieldset>
                                <input name="mere" type="text" class="form-control"  placeholder="Nom de la Mère..." >
                              </fieldset>
                            </div>
                            <div class="col-md-4" id="tuteur">
                                <p>Tuteur</p>
                              <fieldset>
                                <input name="tuteur" type="text" class="form-control"  placeholder="Nom de votre tuteur..." >
                              </fieldset>
                            </div>
                                ...
                                <div class="col-md-6" id="email">
                                     <p>Email *</p>
                                  <fieldset>
                                    <input name="email" type="email" class="form-control" id="email" placeholder="adresse email valide..." required="" >
                                  </fieldset>
                                </div>
                                <div class="col-md-6" id="phone">
                                    <p>Numéro de Téléphone (+261) *</p>
                                  <fieldset>
                                    <input name="phone" id="phone" type="tel" minlength="10" maxlength="13" class="form-control" placeholder="Numéro de télephone valide" required="" >
                                  </fieldset>
                                </div>
                                 <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <fieldset>
                                        <select name="ob_bacc" required="" class="form-control">
                                            <option datd-display="" value="">Votre année d'obtention du bacc</option>
                                 ...
                                 <div class="col-md-4">
                                    <p>Série du bacc *</p>
                                    <fieldset>
                                        <input type="text" name="serie_bacc" class="form-control" placeholder="Votre série du bacc" required>
                                    </fieldset>
                                </div>
                              <div class="col-md-12">
                          <h4> NIVEAU DE FORMATION </h4> 
                            ...
                            <div class="col-md-4 niveau" id="niveau-select" >
                              ...
                              <select name="niveau" id="niveau" onclick="val()" class="form-control" required="" >
                                <option datd-display="" id="n" value="">Choisir votre niveau d'etude</option>
                            ...
                            <div class="col-md-4" id="niveau-select">
                                ...
                                <select name="status" id="passant" required="" class="form-control" >
                                  <option datd-display="" id="situation" value="">Choisir votre situation</option>
                            ...
                            <div class="col-md-12">
                              <h4> CONFIRMATION</h4> 
                                ...
                                <div class="col-md-4">
                                                <fieldset>
                                                  <center><img src="captcha.php" style="height: 45px; width: auto; margin-top: 15px;" /></center></fieldset>
                                </div>
                                <div class="col-md-4">
                                  <fieldset>
                                ...
                                <div class="col-md-4" >
                                        <fieldset>
                                             <button type="submit" name="submit" id="form-submit"  class="btn btn-primary ">Confirmer votre inscription</button>
                                        </fieldset>
                                        ...
                                        ?>
                                        <fieldset>
                                             <a href="edit.php">Vérifier vos informations !</a>
                                        </fieldset>
                                        <?php } ?>
                                </div>
